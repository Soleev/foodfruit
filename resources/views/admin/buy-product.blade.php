...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('admin.users.storePurchase', $user) }}" method="POST">
                ...
                <div class="product-row mb-3">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <select class="form-select @error('product_id.*') is-invalid @enderror" id="product_id_0" name="product_id[]" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control @error('quantity.*') is-invalid @enderror" id="quantity_0" name="quantity[]" value="1" min="1" required>
                            @error('quantity.*')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
            ...
            <button type="button" class="btn btn-success mb-3" id="add-product">Добавить ещё товар</button>
